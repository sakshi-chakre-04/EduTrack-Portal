...
public class BatchEntryController
{
    ...
    @PostMapping
    public ResponseEntity<BatchEntry> createEntry(@RequestBody BatchEntry myentry)//() -> converts to java object
    {
        try
        {
            batchEntryService.saveEntry(myentry);// call service layer to save the data
